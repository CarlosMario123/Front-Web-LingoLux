...
export const CardsDiccionary = ({word}) => {
  ...
  return (
    <div className="flex h-[12rem] rounded-md shadow-lg card-style w-[11rem] flex-col justify-center items-center overflow-hidden cursor-pointer hover:scale-110 duration-150" onClick={irDiccionarios}>
